...
export default function Production()  {
  ...
  useEffect(() => {
      ...
      if (topic === 'data/pa04/pa04dash/0404'){
        ...
        if (pa04) {
          ...
          var jsonPa04 = JSON.parse(pa04.toString());
            ...
            if ((hour === 7) && (minute === 59) ) {
              data1 = jsonPa04.productionHourly;
            }
            
            if ((hour === 8) && (minute === 59) ) {
              data2 = jsonPa04.productionHourly;
            }

            if ((hour === 9) && (minute === 59) ) {
              data3 = jsonPa04.productionHourly;
            }

            if ((hour === 10) && (minute === 59) ) {
              data4 = jsonPa04.productionHourly;
            }
            
            if ((hour === 11) && (minute === 59) ) {
              data5 = jsonPa04.productionHourly;
            }
            
            if ((hour === 12) && (minute === 59) ) {
              data6 = jsonPa04.productionHourly;
            }
            
            if ((hour === 13) && (minute === 59) ) {
              data7 = jsonPa04.productionHourly;
            }
            
            if ((hour === 14) && (minute === 59) ) {
              data8 = jsonPa04.productionHourly;
            }
            
            if ((hour === 15) && (minute === 59) ) {
              data9 = jsonPa04.productionHourly;
            }
            
            if ((hour === 16) && (minute === 59) ) {
              data10 = jsonPa04.productionHourly;
            }
            
            if ((hour === 17) && (minute === 59) ) {
              data11 = jsonPa04.productionHourly;
            }

            if ((hour === 18) && (minute === 59) ) {
              data12 = jsonPa04.productionHourly;
            }
      ...
      const handleJsonMessage = (json) => {
        setProduction(json.hourlyProduction)
        //setOmron(json.OMRON_CP1H_1_DW0)
        console.log(json);
        }
